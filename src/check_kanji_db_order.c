...
int check_kanji_db_order(char const *const *argv, int argc)
{
	...
	addkj("攆"); add_key(0x41, 0x0f);
	addkj("擸"); add_key(0x41, 0x0f);
	...
	addkj("繲"); add_key(0x79, 0x0d);
	addkj("繴"); add_key(0x79, 0x0d);
	addkj("繶"); add_key(0x79, 0x0d);
	addkj("繷"); add_key(0x79, 0x0d);
	addkj("繺"); add_key(0x79, 0x0d);
	addkj("腛"); add_key(0x83, 0x09);
	addkj("腞"); add_key(0x83, 0x09);
	addkj("腢"); add_key(0x83, 0x09);
	addkj("腤"); add_key(0x83, 0x09);
	addkj("腲"); add_key(0x83, 0x09);
	addkj("腶"); add_key(0x83, 0x09);
	addkj("腜"); add_key(0x83, 0x09);
	addkj("艐"); add_key(0x8a, 0x09);
	addkj("艒"); add_key(0x8a, 0x09);
	addkj("艓"); add_key(0x8a, 0x09);
