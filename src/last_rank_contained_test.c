...

{
	...
	"[ 会 ] 2 会作使全体価何先件住供位休企伝光共例具任低似児仲充典余免佐伊依兵伸仮舎伴併伺但仰 (1552 . 3 . 0)\n"
	"[ 信 ] 3 出最内信保写円像個備便係優再値健修処僕側働俺冷催倍倒党停借倉冬傷候凄冊億償傾促凍 (1289 . 1 . 1)\n"
	"[ 函 ] 4 分前動利力加化初切別務制北勝効判割募助削労券勢勤勉創則功到列包勧劇剤刺刊刻刷努副 (1150 . -1 . 0)\n"
	"[ 匙 ] 5 合取名同可参受向単原口友古号各半収台及反医区去協南千印史右午吉又司占厳危卒博即厚 (975 . -2 . -2)\n"
	"[ 告 ] 6 品商地問国回味在員図告営和含周土園器団命君囲呼善困喜因圧固呂吸坂吹咲均否喫坊圏唱 (1398 . 3 . 1)\n"
	"[ 坡 ] 7 大報場変外売多天好女基域夏夜型声士境増太夫失夢城夕堂奈奥契奏壊塩央壁妙塗奇奴塚奨 (1249 . -1 . 0)\n"
	"[ 妬 ] 8 定子学実家安容客始字宅存室宿完害寄宮婚守委嫌嬉季姿密婦娘官宝宇姉宣宜妻姫宗妹宙宴 (1309 . 1 . 1)\n"
	"[ 富 ] 9 対小山屋少川届島工専展局富岡居寝差導属崎左巻州寺察就岩己将履寒尾層審寿射岸寧巨崩 (1238 . -1 . 0)\n"
	"[ 巾 ] 0 年店度市引常広強式帯庫平帰張建座康師希幸布府庭席帳弁幅弱底干幼延廃床幹弟弊幕庁幌 (1237 . 0 . 0)\n"
	"[ 弼 ] q 思当後性心必応得待役形悪彼念御急影忘復快恋徒悩息従恵律恐志弾徴怖微忙患彩怒徳怪徹恥 (1298 . 1 . 1)\n"
	"[ 悲 ] w 情手感成意所投戦愛戻想択技払態承戸担扱打押抜我拡折憶房惑慮抱慣拠慢悲抗才懐懸 (1170 . 0 . 1)\n"
	"[ 括 ] r 持探掲指支提携換放改振接援撮撃採掛描攻推授挙操損揃挑捨掃括排捕握揚摘 (1222 . -1 . 0)\n"
	"[ 政 ] t 日方新料文数明教更旅施早政断曲整族故敵散敗昔昇既易旧敷救旬旨旦敬斜敏 (1522 . 3 . 3)\n"
	"[ 星 ] y 本時書来月期有条材映木村朝望昨普替札未末曜景春星暮服晴昼是暗暑昭暇暖暴束晩 (1211 . 0 . 3)\n"
	"[ 杭 ] p 業楽検様機格果東校案構株板権査標横松根極森枚橋模概植林柄梅桜染析栄樹 (1019 . -4 . -1)\n"
	"[ 橿 ] s 気水次正民求残歩毎止比段歌死欲氏母歳歴毛歯武殺江池永欠汗欄汚歓汁毒欧 (1297 . 1 . 0)\n"
	"[ 汪 ] d 法注活決海流済消治況泉沢泊派深洗洋波浜沖油混清津泣浴液河浮沿添涙浦涼渋 (1149 . -1 . -1)\n"
	"[ 淵 ] g 無点然満演温焼準為火減激源渡照湯港測災漫濃瀬煙煮湖漢潟湾炎滅滞漏炭滑 (1267 . 1 . 0)\n"
	"[ 煽 ] h 用生物理現特産田状版申由環球熱王率独犬父玉猫甘爆片牛犯燃甲狙獲熊献玄珍 (1240 . -1 . -1)\n"
	"[ 男 ] k 発的目画登番相界県直白町男病皆異療痛省盛症留略疲監百盤疑益癒皮看皇盟 (1307 . 2 . 1)\n"
	"[ 眞 ] l 示社私知真確着種稿神研科究石移程福税視積票禁祭称秋短秘破礼稼眠祝督砂瞬礎眼磨穴祉秀 (1164 . -1 . 0)\n"
	"[ 空 ] ; 索立約等第経細組笑素終空紹管答簡系策米納算級築紙籍節精突端競筋紀箱純窓範粉筆紅竹童 (1143 . -2 . -2)\n"
	"[ 紫 ] z 結美続線置総編絞絡義絵絶緒給練統織継縄締群績羽緑維綺縮罪繰緊縁紫網繋 (1317 . 2 . 0)\n"
	"[ 翁 ] x 自者能考良育聞職習致舗肉般興聴舞肌背船老腹航脱脳翌耳腕臭脂至聖耐胸腐臨肩腰脚臣 (1258 . 0 . 0)\n"
	"[ 艱 ] c 行表要色花落術製葉著西英装茶薬苦若藤補荷街複芸菜裏華血草袋融蔵被菓衛衣虫薄裁荒裕薦 (1260 . 0 . 0)\n"
	"[ 覆 ] v 見記言話覧認設読詳語解規計評説観試証親覚訳許角誌訪診討該誕触詰誘詞誤詩託訴誠訓誇訂 (1459 . 3 . 3)\n"
	"[ 調 ] b 買調資販象議護識費談負論豊誰講貸賃谷責請課豆財貴貨謝警賀貼諸貯豪譲貰 (1213 . -2 . 1)\n"
	"[ 賑 ] n 近込車載質返身購転足農起辺軽路赤較走越超賞迎軍輸趣輪躍辞跡辛贈踏距輩 (1136 . -2 . -1)\n"
	"[ 迦 ] m 送通選連道追達違運過週進適速造遊途郎遠遅遣退逆迷逃遺邪那述避郡迫透還 (1299 . 1 . 0)\n"
	"[ 部 ] , 間関部開金録長配野重限都除院門量降酒険防銀阪鉄閉釣闘里郵酸針陸閲鑑郷鍋銘鏡陰鈴 (1268 . 1 . 1)\n"
	"[ 陽 ] . 集電面音際順頭非頂項難雑頃離雨青頼頑章響障階韓静雪隊陽革雰震領露隣隠須雄雲霊随靴預 (1321 . 1 . 2)\n"
	"[ 顆 ] / 高食題風願験類駅館飲顔馬額飛香黒魔養飯魚首鳥鮮魅麗齢髪鹿驚骨黄駄駐麻飼飾鳴駆麺龍麦 (1231 . -3 . -1)\n"
	"各行平均位: 1251.8\n"
	"目標位:  1261\n"
	"合計漢字数:  1250\n"
	"exit: 0\n"
